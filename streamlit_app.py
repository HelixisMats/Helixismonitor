...
def make_dual_axis_chart(df, sensor_left, sensor_right,
    ...
    fig.update_layout(
        height=height,
        margin=dict(l=0, r=0, t=10, b=0),
        yaxis=dict(title=label_left,  titlefont_color=color_left,  tickfont_color=color_left),
        yaxis2=dict(title=label_right, titlefont_color=color_right, tickfont_color=color_right,
